...
public class CustomViewPager extends ViewPager {
    ...
    protected int getChildDrawingOrder(int childCount, int n) {
        // Log.i("CustomViewPager", "childCount : "+childCount +"  childIndex  size :"+childIndex.size()+"    n : "+ n);
        ...
        if (n == 0 || childIndex.size() != childCount) {
            ...
            for (int i = 0; i < childCount; ++i) {
                Log.e("CustomViewPager", "--------------------------");
                int indexAbs = Math.abs(viewCenterX - getViewCenterX(getChildAt(i)));
                Log.e("CustomViewPager", "indexAbs : " + indexAbs  +"  i  : "+i);
        ...
        Log.e("CustomViewPager", "getChildDrawingOrder : " + " childCount : " + childCount + "    n : " + n + "  position : " + position +"   abs : "+abs+ "   index : " + index);
        return index;
